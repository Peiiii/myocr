...
##转换keras模型 参考tools目录
ocrModelKerasDense       = os.path.join(pwd,"weights","ocr-dense.h5")
ocrModelKerasLstm        = os.path.join(pwd,"weights","ocr-lstm.h5")
ocrModelKerasEng         = os.path.join(pwd,"weights","ocr-english.h5")

ocrModelTorchLstm        = os.path.join(pwd,"weights","ocr-lstm.pth")
ocrModelTorchDense       = os.path.join(pwd,"weights","ocr-dense.pth")
ocrModelTorchEng         = os.path.join(pwd,"weights","ocr-english.pth")

ocrModelOpencv           = os.path.join(pwd,"weights","ocr.pb")
